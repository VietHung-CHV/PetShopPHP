$(document).ready(function(){
    ...
    $('#adminLogin').submit(function(e){
        ...
        if(username == '' || password == ''){
            $('#adminLogin').append('<div class="alert alert-danger">Điền đầy đủ các dòng</div>');
        }else{
            $.ajax({
                ...
                success: function(response){
                    ...
                    if(res.hasOwnProperty('success')){
                        $('#adminLogin').append('<div class="alert alert-success">Đăng nhập thành công.</div>');
                        setTimeout(function(){ window.location = URL+'admin/dashboard.php'; }, 1000);
                    }else if(res.hasOwnProperty('error')){
                        $('#adminLogin').append('<div class="alert alert-danger">Tên đăng nhập và mật khẩu không trùng khớp.</div>');
                    } else {
                        $('#adminLogin').append('<div class="alert alert-danger">loi blabla</div>');
                    }
                }
            });
        }
    ...
    $('#changePassword').submit(function(e){
        ...
        if(oldPass == '' || newPass == ''){
            $('#changePassword').prepend('<div class="alert alert-danger">Điền đầy đủ các dòng!</div>');
        }else{
            ...
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = JSON.parse(response);
                    if(res.hasOwnProperty('success')){
                        $('#changePassword').prepend('<div class="alert alert-success">Thay đổi mật khẩu thành công.</div>');
                        setTimeout(function(){ window.location = URL+'admin/dashboard.php'; }, 1000);
                    }else if(res.hasOwnProperty('error')){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                if(res.hasOwnProperty('sub_category')){
                    var sub_cat = '<option value="" selected disabled>Chọn danh mục con</option>';
                ...
                //     var brand = '<option value="" selected disabled>Chọn brand</option>';
    ...
    $('#createCategory').submit(function(e){
        ...
        if(cat == ''){
            $('#createCategory').prepend('<div class="alert alert-danger">Trường danh mục trống.</div>');
        }else{
            var formdata = new FormData(this);
            formdata.append('create','1');
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#createCategory').prepend('<div class="alert alert-success">Thêm danh mục thành công.</div>');
    ...
    $('#updateCategory').submit(function(e){
        ...
        if(cat == ''){
            $('#updateCategory').prepend('<div class="alert alert-danger">Trường danh mục trống.</div>');
        }else{
            var formdata = new FormData(this);
            formdata.append('update','1');
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#updateCategory').prepend('<div class="alert alert-success">Chỉnh sửa thành công.</div>');
                        setTimeout(function(){ window.location = URL+'admin/category.php'; }, 1000);
    ...
    $('#updateOptions').submit(function(e){
        ...
        if(site_name == ''){
            $('#updateOptions').prepend('<div class="alert alert-danger">Trường tên đang để trống.</div>');
        }if(site_title == ''){
            $('#updateOptions').prepend('<div class="alert alert-danger">Trường tiêu đề đang để trống.</div>');
        }else if(footer_text == ''){
            $('#updateOptions').prepend('<div class="alert alert-danger">Trường footer đang để trống.</div>');
        }else if(currency == ''){
            $('#updateOptions').prepend('<div class="alert alert-danger">Trường đơn vị tiền tệ đang trống.</div>');
        }else if(desc == ''){
            $('#updateOptions').prepend('<div class="alert alert-danger">Trường mô tả đang trống.</div>');
        }else if(phone == ''){
            $('#updateOptions').prepend('<div class="alert alert-danger">Trường điện thoại đang trống.</div>');
        }else if(email == ''){
            $('#updateOptions').prepend('<div class="alert alert-danger">Trường email đang trống.</div>');
        }else if(address == ''){
            $('#updateOptions').prepend('<div class="alert alert-danger">Trường địa chỉ đang trống.</div>');
        }else{
            var formdata = new FormData(this);
            formdata.append('update',1);
            $.ajax({
                ...
                success: function(response){
                    ...
                    var res = response;
                    if(res.hasOwnProperty('success')){
                        $('#updateOptions').prepend('<div class="alert alert-success">Cập nhật thông tin hệ thống thành công.</div>');
