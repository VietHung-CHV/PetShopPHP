        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="detail-box">
                    ...
                    <span class="count-tag">Sản phẩm</span>
                </div>
            </div>
            <div class="col-md-4">
                <?php
                ...
                <div class="detail-box">
                    ...
                    <span class="count-tag">Danh mục</span>
                </div>
            </div>
            <div class="col-md-4">
                <div class="detail-box">
                    ...
                    <span class="count-tag">Danh mục con</span>
                </div>
            </div>
            <!-- <div class="col-md-4">
                <div class="detail-box">
            ...
            <div class="col-md-4">
                <div class="detail-box">
                    ...
                    <span class="count-tag">Đơn hàng</span>
                </div>
            </div>
            <div class="col-md-4">
                <div class="detail-box">
                    ...
                    <span class="count-tag">Người dùng</span>
                </div>
            </div>
        </div>
    </div>
