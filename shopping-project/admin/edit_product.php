...
<div class="admin-content-container">
    <h2 class="admin-heading">Chỉnh sửa sản phẩm</h2>
    <?php
    $id = $_GET['id'];
    $db = new Database();
        ...
        foreach($result as $row) { ?>
            <form id="updateProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
                <div class="col-md-9">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control product_title" name="product_title"
                               value="<?php echo $row['product_title']; ?>" placeholder="Tiêu đề sản phẩm"/>
                    </div>
                    ...
                    <div class="form-group sub_category">
                        <label for="">Danh mục con sản phẩm</label>
                        <?php
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <label for="">Số lượng khả dụng</label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control product_status" name="product_status">
                            <option <?php //if($row['product_status'] == '1') echo 'selected'; ?> value="1">Được bán</option>
                            <option <?php //if($row['product_status'] == '0') echo 'selected'; ?> value="2">Không bán</option>
                        </select>
                    </div>
                    <div class="form-group">
