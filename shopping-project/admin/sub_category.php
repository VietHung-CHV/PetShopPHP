...
<div class="admin-content-container">
    <h2 class="admin-heading">Danh mục con</h2>
    <a class="add-new pull-right" href="add_sub_category.php">Thêm mới</a>
    <?php
    $limit = 10;
    $db = new Database();
    ...
    <?php }else{ ?>
        <div class="not-found">!!! Không có danh mục con nào !!!</div>
    <?php    }  ?>
