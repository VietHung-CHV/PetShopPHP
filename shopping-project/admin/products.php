...
include 'header.php'; ?>
    <div class="admin-content-container">
        <h2 class="admin-heading">Tất cả sản phẩm</h2>
        <a class="add-new pull-right" href="add_product.php">Thêm mới</a>
        <?php
        $limit = 10;
        $db = new Database();
            ...
            <table id="productsTable" class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['product_price'].' '.$currency_format; ?></td>
                        ...
                        <td><?php
                                if($row['product_status'] == '1'){
                                    ...
                                    echo '<span class="label label-danger">Không bán</span>';
                                }
                            ?>
                        </td>
                        <td>
        ...
        <?php }else{ ?>
            <div class="not-found clearfix">!!! Không tìm thấy sản phẩm nào !!!</div>
        <?php    } ?>
