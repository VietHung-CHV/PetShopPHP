        ...
        <form id="createProduct" class="add-post-form row" method="post" enctype="multipart/form-data">
            <div class="col-md-9">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control product_title" name="product_title" placeholder="Tiêu đề sản phẩm" requried/>
                </div>
                <div class="form-group category">
                    ...
                    $r = mysqli_query($conn1, "SELECT * FROM categories ORDER BY categories.cat_id DESC");
            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input min="1" type="number" class="form-control product_qty" name="product_qty" requried value="">
                </div>
                <div class="form-group">
                    <label>Trạng thái</label>
                    <select class="form-control product_status" name="product_status">
                        <option selected value="1">Được bán</option>
                        <option value="2">Không bán</option>
                    </select>
                </div>
                <div class="form-group">
                    <input type="submit" class="btn add-new" name="submit" value="Thêm">
                </div>
            </div>
        </form>
    </div>
