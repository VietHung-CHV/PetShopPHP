        ...
        if(!isset($_POST['s_no']) || empty($_POST['s_no'])){
            ...
            if(!empty($errors)){
               echo json_encode($errors); exit;
                ...
                // $site_name = mysqli_real_escape_string($conn1, $data);

                // $data = $_POST['site_title'];
                // $data = trim($data);
                // $data = stripslashes($data);
                // $data = htmlspecialchars($data);
                // $site_title = mysqli_real_escape_string($conn1, $data);

                // $site_logo = mysqli_real_escape_string($conn1, $file_name);

                // $data = $_POST['footer_text'];
                // $data = trim($data);
                // $data = stripslashes($data);
                // $data = htmlspecialchars($data);
                // $footer_text = mysqli_real_escape_string($conn1, $data);

                // $data = $_POST['currency_format'];
                // $data = trim($data);
                // $data = stripslashes($data);
                // $data = htmlspecialchars($data);
                // $currency_format = mysqli_real_escape_string($conn1, $data);

                // $data = $_POST['site_desc'];
                // $data = trim($data);
                // $data = stripslashes($data);
                // $data = htmlspecialchars($data);
                // $site_desc = mysqli_real_escape_string($conn1, $data);

                // $data = $_POST['contact_phone'];
                // $data = trim($data);
                // $data = stripslashes($data);
                // $data = htmlspecialchars($data);
                // $contact_phone = mysqli_real_escape_string($conn1, $data);

                // $data = $_POST['contact_email'];
                // $data = trim($data);
                // $data = stripslashes($data);
                // $data = htmlspecialchars($data);
                // $contact_email = mysqli_real_escape_string($conn1, $data);

                // $data = $_POST['contact_address'];
                // $data = trim($data);
                // $data = stripslashes($data);
                // $data = htmlspecialchars($data);
                // $contact_address = mysqli_real_escape_string($conn1, $data);
                $params = [
                ...
                // $sql2 = "UPDATE options SET $params WHERE s_no=$_POST['s_no'] ";
